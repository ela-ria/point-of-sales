...
class SaleController extends Controller
{
    ...
    // POST /api/sales/{id}/items  — add a product to the sale
    ...
    // DELETE /api/sales/{id}/items/{itemId}  — void a single item
    ...
    // POST /api/sales/{id}/discount  — apply a discount type
    ...
    // POST /api/sales/{id}/complete  — complete and print receipt
    public function complete(Request $request, $id)
    {
        ...
        // Deduct stock for each active item
    ...
    // POST /api/sales/{id}/cancel  — cancel before payment
    ...
    // POST /api/sales/{id}/post-void  — void after completion (supervisor)
